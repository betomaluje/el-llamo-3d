...
8. Under Window -> AI -> Navigation, open that window and adjust the settings. Click on "Bake" button
9. Under Window -> Rendering -> Lightning Settings, open the window
10. In there, change the Skybox and Directional Light in the Environment tab
11. Click the "Generate Lightning" button on the bottom of that window
